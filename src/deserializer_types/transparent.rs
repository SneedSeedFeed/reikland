...
/// A newtype wrapper that transparently handles sequence-wrapped values such as instance variables by taking the first member of teh sequence, then optionally tries to take the second
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
/// A newtype wrapper that transparently handles sequence-wrapped values such as instance variables by taking the second member of the sequence then draining the remainder
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
#[repr(transparent)]
